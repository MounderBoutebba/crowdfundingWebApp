    ...
    public class Asset
    {
        ...
        public Task<JsonRpcResponse<string>> IssueFromAsync(string fromAddress, string toAddress, object assetName, int quantity, decimal units, [Optional]object metaData, decimal nativeAmount = 0, string comment = null, string commentTo = null, int startBlock = 0, int endBlock = 0)
        {
            if (metaData == null)
                ...
                return _Client.ExecuteAsync<string>("issuefrom", 0, fromAddress, toAddress, assetName, quantity, units, nativeAmount, metaData);
        }
        ...
        /// <param name="metaData"></param>
        /// <returns></returns>
        public Task<JsonRpcResponse<string>> IssueMoreFromAsync(string fromAddress, string toAddress, object assetName, int quantity, [Optional] decimal nativeAmount, object metaData = null)
        {
            if (metaData == null)
