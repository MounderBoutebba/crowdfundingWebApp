...
namespace LucidOcean.MultiChain.API
{
    public class Transaction
    {
        ...
        /// <returns></returns>
        public Task<JsonRpcResponse<SignedTransactionResponse>> SignRawTransactionAsync(string txHex, string[] privateKeys, string sighashtype = "ALL", object[] parent = null)
        {
            return _Client.ExecuteAsync<SignedTransactionResponse>("signrawtransaction", 0, txHex, parent, privateKeys, sighashtype);
        }
        ...
        /// <returns></returns>
        public Task<JsonRpcResponse<Validateaddress>> validateaddress(string privateKey)
        {
            return _Client.ExecuteAsync<Validateaddress>("validateaddress", 0, privateKey);
        }
    }
}
